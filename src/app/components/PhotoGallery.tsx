            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  ...
                  <p className="text-slate-400 text-xs mt-1">© OOO JSC SUEK</p>
                </div>
              </div>
              {item.type === "video" && (
              ...
              <div className="absolute top-3 right-3">
                <div className="bg-slate-900/80 backdrop-blur-sm px-2 py-1 rounded flex items-center gap-1">
                  ...
                  <span className="text-white text-xs font-mono uppercase">{item.type}</span>
                </div>
              </div>
            </div>
          ))}
                  ...
                  <div className="aspect-video bg-slate-900 relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center p-8 bg-slate-900/80 backdrop-blur-sm rounded-2xl">
                        ...
                        <p className="text-white text-lg font-semibold mb-2">{selectedItem.title}</p>
                        <p className="text-slate-300 text-sm mb-4">
                          Professional OOO JSC SUEK video content
                        </p>
                        <p className="text-amber-400 text-xs font-mono">
                          Click play to view official company footage
                        </p>
                      </div>
                    </div>
                  </div>
